            ...
            <form>
                <div class="search-form-filters">
                    <div>
                        ...
                        <section class="category-filter filter m-md-bottom"><br><br>
                            <label class="control-label"><a href="<?php echo Request::root();?>/inbox" style="text-decoration: none; color: navy;"><span class="glyphicon glyphicon-inbox"></span>&nbsp;&nbsp;&nbsp;&nbsp;Inbox&nbsp;&nbsp;({{$inbox_num}})&nbsp;&nbsp;&nbsp;&nbsp;</a></label><hr>
