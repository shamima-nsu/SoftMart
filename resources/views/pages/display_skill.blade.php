                                ...
                                <ul class="list-unstyled">
                                    @foreach($skills as $sk)
                                        ...
                                        @else
                                            ...
                                            @else
                                                <li><a style="text-decoration: none; color: navy; font-weight: 600;" href="<?php echo Request::root();?>/pages/display_on_skill/<?php echo $sk->id;?>">{{$sk->skill}}&nbsp; ({{$s_num}})</a></li><br>
                                            @endif
                                                ...
                                                @if($sp->postId==$post->id)
                                                    ...
                                                    <br>
                                                        ...
                                                        <div class="o-support-info m-sm-bottom m-sm-top">
                                                            ...
                                                            <span class="js-posted"><b>Deadline : </b>&nbsp;
                                                                <?php
